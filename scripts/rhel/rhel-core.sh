...
wget -nv -O "${CLOUD_INIT_DS_DIR}/sources/DataSourceRbxCloud.py" https://raw.githubusercontent.com/canonical/cloud-init/20.2/cloudinit/sources/DataSourceRbxCloud.py
